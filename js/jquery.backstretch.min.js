    ...
    b.extend({
        ...
        buildFragment: function(e, t, n, r) {
            ...
            for (; p > h; h++)
                ...
                if (!b.support.leadingWhitespace && yt.test(o) && d.push(t.createTextNode(yt.exec(o)[0])), !b.support.tbody) { o = "table" !== u || xt.test(o) ? "<table>" !== c[1] || xt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; while (i--) b.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l) }
...
(function(a, d, p) {
    a.fn.backstretch = function(c, b) {
        ...
        return this.each(function() {
            ...
            if (g) {
                if ("string" == typeof c && "function" == typeof g[c]) { g[c](b); return }
    ...
    a.fn.backstretch.defaults = { centeredX: !0, centeredY: !0, duration: 5E3, fade: 0, style: '', callback: function() {} };
    var r = { left: 0, top: 0, overflow: "hidden", margin: 0, padding: 0, height: "100%", width: "100%", zIndex: -999999 },
        ...
        q = function(c, b, e) {
            ...
            this.$wrap = c.length ? c : a('<div class="backstretch ' + this.options.style + '"></div>').css(r).appendTo(this.$container);
    ...
    q.prototype = {
        ...
        cycle: function() { 1 < this.images.length && (clearInterval(this.interval), this.interval = setInterval(a.proxy(function() { this.paused || this.next() }, this), this.options.duration)); return this },
        destroy: function(c) {
